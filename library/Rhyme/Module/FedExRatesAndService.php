...
class FedExRatesAndService extends ModuleIsotope
{
	 ...
	 * @var string
	 */
	protected $strTemplate = 'mod_iso_fedexratesandservice';

	protected $strFormId = 'iso_mod_fedex_rates_and_service';
	...
	protected function generateAddressWidgets($strAddressType, $intOptions)
	{
		...
		if ($this->Input->post('FORM_SUBMIT') == $this->strFormId && !$this->doNotSubmit && is_array($arrAddress) && count($arrAddress))
		{
			...
			$this->Template->fedexDisclaimer = $arrTransit['TimeInTransitResponse']['TransitResponse']['Disclaimer'];
		}
